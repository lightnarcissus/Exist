...
//	public static bool interact=false;
	...
	//	{
		...
		if(distance>150f)
			{
				transform.position=new Vector3(player.transform.position.x+Random.Range(-200f,200f),transform.position.y,player.transform.position.z+Random.Range (-200f,200f));
			}
			if(pathEnd<3f)
			{
				//Debug.Log("end");
