	...
	public class PlayerSetupWizard : EditorWindow {
		...
		private void DrawSelector(SelectorType selectorType) {
			...
			if (selector.reticle != null) {
				selector.reticle.inRedRange = EditorGUILayout.ObjectField("In-Range Red Reticle", selector.reticle.inRedRange, typeof(Texture2D), false) as Texture2D;
				selector.reticle.inBlueRange = EditorGUILayout.ObjectField("In-Range Blue Reticle", selector.reticle.inBlueRange, typeof(Texture2D), false) as Texture2D;
				selector.reticle.inGreyRange = EditorGUILayout.ObjectField("In-Range Grey Reticle", selector.reticle.inGreyRange, typeof(Texture2D), false) as Texture2D;
				selector.reticle.inGoldRange = EditorGUILayout.ObjectField("In-Range Gold Reticle", selector.reticle.inGoldRange, typeof(Texture2D), false) as Texture2D;
