...
namespace PixelCrushers.DialogueSystem.Examples {
	...
	public class Selector : MonoBehaviour {
		...
		public class Reticle {
			public Texture2D inRedRange;
			public Texture2D inBlueRange;
			public Texture2D inGoldRange;
			public Texture2D inGreyRange;
		...
		void OnGUI() {
			if (useDefaultGUI) {
				...
				if (usable != null) {
					//inUseRange = (distance <= usable.maxUseDistance);
					...
					UnityGUITools.DrawText(screenRect, heading, actualStyle, TextStyle.Shadow);
					UnityGUITools.DrawText(new Rect(0, actualStyle.CalcSize(new GUIContent("Ay")).y, Screen.width, Screen.height), useMessage, actualStyle, TextStyle.Shadow);
