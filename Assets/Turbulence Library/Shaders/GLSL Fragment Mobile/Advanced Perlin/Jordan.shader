...
Shader "Noise/Mobile/Advanced Perlin/Jordan" 
{
	Properties 
	{
		...
		_Warp0("Warp 0", Float) = -1.0
		_Warp("Warp", Float) = 0.6
		_Damp0("Damp 0", Float) = 1.0
		_Damp("Damp", Float) = 0.8
		_DampScale("Damp Scale", Float) = 0.5
	}
	...
	SubShader 
	{
		Pass
		{
			...
			{
				vec4 n = PerlinSurflet3D_Deriv(p+offset);
				vec4 n2 = n * n.x;
				float sum = n2.x;
