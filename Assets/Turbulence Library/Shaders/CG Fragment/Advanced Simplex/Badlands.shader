...
Shader "Noise/CG/Advacned Simplex/Badlands" 
{
	Properties 
	{
	...
	SubShader 
	{
		Pass
		{
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float h = fBM(float3(i.worldPos.xz, _Time*_AnimSpeed), _Octaves, _Floor, _NoiseOffset, _NoiseScale, turbulence, _TurbulencePower, _Frequency, _Amplitude, _Lacunarity, _Persistence, _Powered, _RidgePower, _RidgeOffset, _Warp);
