...
public class MeteorScript : MonoBehaviour {
	...
	private static float _baseDuration = 300f;
	...
	*/
	...
	public Color color = MeteorScript._baseColor;
	public bool explodeOnStart = true;
	public float duration = MeteorScript._baseDuration;
	public float detail = 1f; 
